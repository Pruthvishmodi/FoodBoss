...
import { supportURL } from "../functions/url";

const SellerContact = ({supportData}) => {
  return (
    <>
    <Head>
...
export const getServerSideProps = async({req,res})=>{
  res.setHeader(
    ...
    try {
      const hero = (await axios.get('https://admin.foodboss.in/api/page-supports?filters[pageName][$eq]=seller')).data;
      const heroData = (await axios.get('https://admin.foodboss.in/api/supports?filters[page_support][pageName][$eq]=seller&populate=*')).data;
