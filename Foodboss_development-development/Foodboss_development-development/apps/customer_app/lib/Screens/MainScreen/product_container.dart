...
class ProductContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    MainScreenController ctrl = Get.find<MainScreenController>();
      ...
      child: Column(
        children: [
            ...
            child: GestureDetector(
              onTap: () {
                productController.fetchProductDetails(
                    product.shop!.id,
                    product.id,
                    ctrl.randomproductsbyshops[shopIndex]
                        .randomProducts![prodIndex].quantity!,
                    0);
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      product.price.toString() == product.discount.toString()
                          ? SizedBox()
                          : const SizedBox(
                              width: 5,
                            ),
          ...
          Obx(
            () => NewCounter(
              width: double.infinity,
              count: ctrl.randomproductsbyshops[shopIndex]
                  .randomProducts![prodIndex].quantity!,
              increment: () async {
                ...
                if (call["success"] == true) {
                  ctrl.randomproductsbyshops[shopIndex]
                      .randomProducts![prodIndex].quantity = ctrl
                          .randomproductsbyshops[shopIndex]
                          .randomProducts![prodIndex]
                          .quantity! +
                      1;
                  ctrl
                      .randomproductsbyshops[shopIndex]
                      .randomProducts![prodIndex]
                      .deleteCartId = int.parse(call["cart_id"].toString());
                  userController.cartController.addToCart();
                  ctrl.randomproductsbyshops.refresh();
                }
              },
              decrement: () async {
                if (ctrl.randomproductsbyshops[shopIndex]
                        .randomProducts![prodIndex].quantity! >
                    1) {
                  print('here');
                  var call = await userController.cartController
                  ...
                  if (call["success"] == true) {
                    ...
                    ctrl
                        ...
                        .deleteCartId = int.parse(call["cart_id"].toString());
                    print(call["cart_id"]);
                    print(ctrl.randomproductsbyshops[shopIndex]
                        .randomProducts![prodIndex].deleteCartId);
                  ...
                  print('removed');
                  var call = await userController.cartController
                      .removeToCARTDIRECTLY(ctrl
                          .randomproductsbyshops[shopIndex]
                          .randomProducts![prodIndex]
                          .deleteCartId!);
                  if (call) {
                    ctrl.randomproductsbyshops[shopIndex]
                        .randomProducts![prodIndex].quantity = 0;
                    userController.cartController.removeFromCart();
