class NewOrderStoreListModel {
  bool? success;
  Data? data;

  NewOrderStoreListModel({this.success, this.data});

  NewOrderStoreListModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.totalNewOrders, this.newOrders});
