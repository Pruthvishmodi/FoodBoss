class GetCompletedList {
  ...
  GetCompletedList({this.success, this.data});

  GetCompletedList.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  List<ProgressOrders>? progressOrders;

  Data({this.totalCompletedOrders, this.progressOrders});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['progress_orders'] != null) {
      ...
      json['progress_orders'].forEach((v) {
        progressOrders!.add(new ProgressOrders.fromJson(v));
      });
    }
  }
...
class ProgressOrders {
  ...
  ProgressOrders.fromJson(Map<String, dynamic> json) {
    date = json['date'];
