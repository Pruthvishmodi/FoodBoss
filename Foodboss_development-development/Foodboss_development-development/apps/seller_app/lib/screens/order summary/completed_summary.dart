...
class CompletedSummary extends StatefulWidget {
  final String? type;
  final String? id;
  final String? status;

  const CompletedSummary({Key? key, this.type, this.id, this.status})
      : super(key: key);

  @override
  State<CompletedSummary> createState() => _CompletedSummaryState();
}

class _CompletedSummaryState extends State<CompletedSummary> {
  var _value;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.completedStatus == States.SUCCESS_STATE) {
          print('asds${widget.id}');
          var order = controller.completedData.data!.firstWhere((element) {
                              ...
                              children: [
                                Expanded(
                                    child: order.comments == ""
                                        ? const Desc(descString: "No Comments")
                                        : Desc(
                                        ...
                                        Expanded(
                                          child: Column(
                                              ...
                                              children: [
                                                ...
                                                Desc(
                                                    descString:
                                                        "Vehicle Number: ${order.driver!.vehicle}"),
                                              ]),
                                        )
                                      ],
                                    ),
