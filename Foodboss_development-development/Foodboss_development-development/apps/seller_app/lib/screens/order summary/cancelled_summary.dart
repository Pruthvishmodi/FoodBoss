...
class CancelledSummary extends StatefulWidget {
  final String? type;
  final String? id;
  final String? status;

  const CancelledSummary({Key? key, this.type, this.id, this.status})
      : super(key: key);

  @override
  State<CancelledSummary> createState() => _CancelledSummaryState();
}

class _CancelledSummaryState extends State<CancelledSummary> {
  var _value;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.cancelledStatus == States.SUCCESS_STATE) {
          print('asd${widget.id}');
          var order = controller.cancelledData.data!.firstWhere((element) {
