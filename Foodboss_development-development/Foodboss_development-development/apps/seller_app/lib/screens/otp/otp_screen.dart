...
import 'package:seller_app/controller/business_controller/auth/otp_controller.dart';
import 'package:seller_app/screens/home/home_screen.dart';
import 'package:seller_app/screens/otp/otp_form.dart';
...
List<Widget> getList(Size size, 
OtpController controllerAuth
)
 => [
      SizedBox(
      ...
      Padding(
        ...
        child: OtpFormFields(textEditingController: controllerAuth,),
      ),
