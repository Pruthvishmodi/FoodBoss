...
import 'package:seller_app/widgets/food_boss_popup_card.dart';
            ...
            children: [
              const SizedBox(
               ...
               Expanded(
                ...
                Expanded(
                  flex: 1,
                  child: FoodBossButtons(width: 400,height: 50,text: "Done", color: Conifg.primaryColor, bradius: 20.0, textcolor: Colors.white, fsize: 20, op: (){}, type: "filled", bwidth: 20)),
