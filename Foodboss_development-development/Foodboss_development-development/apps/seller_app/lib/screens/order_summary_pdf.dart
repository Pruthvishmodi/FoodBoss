...
import 'package:seller_app/widgets/pending_order_card.dart';
import 'package:seller_app/widgets/product_list.dart';

class OrderSummaryPdf extends StatelessWidget {
  const OrderSummaryPdf({Key? key}) : super(key: key);
